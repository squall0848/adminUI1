...
<script setup lang="ts">
  ...
  const initFormData = () => {
    ...
    Object.assign(formData, {
      ...
      weight: isEdit && row ? row.weight || 0 : 0,
      ...
      fixed_amount: isEdit && row ? row.fixed_amount : undefined,
    ...
    try {
      if (dialogType.value === 'add') {
        ...
        if (formData.amount_limit === 1) {
          ...
          if (formData.fixed_amount !== undefined) {
            params.fixed_amount = formData.fixed_amount
          }
        }
