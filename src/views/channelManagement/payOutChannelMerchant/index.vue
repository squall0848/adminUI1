...
<script setup lang="ts">
  ...
  import ChannelMerchantSearch from '../payInChannelMerchant/modules/channel-merchant-search.vue'
  import ChannelMerchantDialog from '../payInChannelMerchant/modules/channel-merchant-dialog.vue'
  import { ElCard, ElSpace, ElMessageBox, ElSwitch, ElButton, ElMessage } from 'element-plus'
  import { DialogType } from '@/types'

  defineOptions({ name: 'PayOutChannelMerchant' })
