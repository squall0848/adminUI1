...
<script setup lang="ts">
  ...
  import ProductSearch from '../payInProduct/modules/product-search.vue'
  import ProductDialog from '../payInProduct/modules/product-dialog.vue'
  import { ElMessageBox, ElSwitch, ElButton, ElMessage, ElTag } from 'element-plus'
  import { DialogType } from '@/types'

  defineOptions({ name: 'PayOutProduct' })
