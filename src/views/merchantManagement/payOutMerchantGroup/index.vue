  ...
  <div class="merchant-group-page art-full-height">
    ...
    <ElCard class="art-table-card" shadow="never">
      ...
      <ArtTableHeader v-model:columns="columnChecks" :loading="tableLoading" @refresh="refreshData">
        <template #left>
          <ElSpace wrap>
            <ElButton type="primary" @click="showDialog('add')" v-ripple>新增代付商户组</ElButton>
            <ElButton
              type="danger"
...
<script setup lang="ts">
  ...
  import MerchantGroupDialog from '../payInMerchantGroup/modules/merchant-group-dialog.vue'
  import { DialogType } from '@/types'
  import { h } from 'vue'
  import { ElButton } from 'element-plus'

  defineOptions({ name: 'PayOutMerchantGroup' })
