...
export default ({ mode }: { mode: string }) => {
  ...
  console.log(`🚀 VITE_TAG = ${VITE_TAG}`)
  console.log(`🚀 VITE_ADMIN_URL = ${VITE_ADMIN_URL}`)
  console.log(`🚀 VITE_MERCHANT_URL = ${VITE_MERCHANT_URL}`)
  console.log(`🚀 VITE_AGENT_URL = ${VITE_AGENT_URL}`)
